...
//        FastAutoGenerator.create("jdbc:mysql://192.168.1.20:3306/yf?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL&useSSL=false&serverTimezone=CTT", "root", "root")
        FastAutoGenerator.create("jdbc:mysql://20.tcp.cpolar.top:10360/yf?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL&useSSL=false&serverTimezone=CTT", "root", "root")
...
//                    builder.parent("com.npc.auth.admin") // 设置父包名
                ...
                .strategyConfig(builder -> {
                    ...
                    builder.addInclude("diet_recipes,diet_eaten_dishes") // 设置需要生成的表名
