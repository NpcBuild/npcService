...
//        RedisPoolUtil.del(RedisKeysConstant.STOCK_VERSION + stock.getVersion());
        cacheService.delete(RedisKeysConstant.STOCK_COUNT + stock.getCount());
        cacheService.delete(RedisKeysConstant.STOCK_SALE + stock.getSale());
        cacheService.delete(RedisKeysConstant.STOCK_VERSION + stock.getVersion());
        //缓存预热
        int sid = stock.getId();
...
//        RedisPoolUtil.set(RedisKeysConstant.STOCK_VERSION + sid, String.valueOf(stock.getVersion()));
        cacheService.set(RedisKeysConstant.STOCK_COUNT + sid, String.valueOf(stock.getCount()));
        cacheService.set(RedisKeysConstant.STOCK_SALE + sid, String.valueOf(stock.getSale()));
        cacheService.set(RedisKeysConstant.STOCK_VERSION + sid, String.valueOf(stock.getVersion()));
    }
}
